...
app.controller('mainController', function($http, $log){
    ...
    $log.info('cuisine: ', this.cuisine);

    this.get_recipe_info = function(){
        $http({
            method: 'GET',
            url: 'https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/search' + this.cuisine_key + '&number=25&license=true',
            headers: {
